...
echo "Received Data: Doc ID = $docid, Name = $docname, Specialization = $sp, Date = $ddate, Time = $dtime";
...
<?php
  ...
  $result = $conn->query($sql);
  echo '<a href = "http://127.0.0.1:5500/index.html"><button>Start the video call</button></a> ';
  echo '<link rel = "stylesheet" href = "doctor_table.css"> ';
  echo "<body>";
